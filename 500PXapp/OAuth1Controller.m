...
#define OAUTH_CALLBACK       @"techpark_ios" //Sometimes this has to be the same as the registered app callback url
#define CONSUMER_KEY         @"XyuX14AQBpiWjfUcRyXA2jyB5ensjjJD6gBFcGHI"
#define CONSUMER_SECRET      @"wlXOElFUY7hjkHffppk36PyrXdNa44mmr7MseWVL"
#define AUTH_URL             @"https://api.500px.com/v1/"
...
#define API_URL              @"https://api.500px.com/v1/"
#define OAUTH_SCOPE_PARAM    @""
